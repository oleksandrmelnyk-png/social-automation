...
@Slf4j
@Service
public class TikTokLikeActionHandler extends TikTokActionHandler {

    private final PlaywrightHelper playwrightHelper;

    private final TikTokService tikTokService;

    public TikTokLikeActionHandler(TikTokService tikTokService, PlaywrightHelper playwrightHelper, PlaywrightInitializer playwrightInitializer, TikTokPlaywrightHelper tikTokPlaywrightHelper, PlaywrightHelper playwrightHelper1, TikTokService tikTokService1) {
        super(tikTokService, playwrightHelper, playwrightInitializer, tikTokPlaywrightHelper);
        this.playwrightHelper = playwrightHelper1;
        this.tikTokService = tikTokService1;
    }
