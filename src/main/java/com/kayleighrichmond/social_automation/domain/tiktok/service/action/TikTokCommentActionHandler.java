...
@Slf4j
@Service
public class TikTokCommentActionHandler extends TikTokActionHandler {

    private final TikTokService tikTokService;

    public TikTokCommentActionHandler(TikTokService tikTokService, PlaywrightHelper playwrightHelper, PlaywrightInitializer playwrightInitializer, TikTokPlaywrightHelper tikTokPlaywrightHelper, TikTokService tikTokService1, TikTokPlaywrightHelper tikTokPlaywrightHelper1, PlaywrightInitializer playwrightInitializer1, PlaywrightHelper playwrightHelper1, TikTokService tikTokService2) {
        super(tikTokService, playwrightHelper, playwrightInitializer, tikTokPlaywrightHelper);
        this.tikTokService = tikTokService2;
    }
